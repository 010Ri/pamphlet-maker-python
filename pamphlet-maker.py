...
def insert_ad_8_L(id, ad1, ad2, ad3, ad4, ad5, ad6, ad7, ad8):
    slide = pt.slides[id]  # layout-flame_something
    # 画像の挿入
    file_path = ad1
...
def insert_ad_8_R(id, ad1, ad2, ad3, ad4, ad5, ad6, ad7, ad8):
    slide = pt.slides[id]  # layout-flame_something
    # 画像の挿入
    file_path = ad1
...
for layout_flame in layout_flame_list:
    ...
    if layout_flame == "layout-flame_1-L" :
        ...
        insert_textbox_1_L(id)
        insert_ad_8_L(id, ad1, ad2, ad3, ad4, ad5, ad6, ad7, ad8)
        ...
        ad8 = ads[length-length]
        insert_textbox_1_R(id)
        insert_ad_8_R(id, ad1, ad2, ad3, ad4, ad5, ad6, ad7, ad8)
